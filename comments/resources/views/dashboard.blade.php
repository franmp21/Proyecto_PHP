            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="bg-gray-100 p-4 mb-4 rounded shadow">
                        ...
                        <form action="{{ route('replies.store', $comment->id) }}" method="POST" class="px-6 mb-4">
                            @csrf
                            
                            <input placeholder="Responder..." type="text" name="body" class="w-full text-xs text-gray-500 border border-gray-200 bg-gray-100 p-2">
                        </form>
                    </div>
